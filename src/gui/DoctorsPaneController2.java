...
public class DoctorsPaneController2 implements Initializable{
  		   ...
  		   if(speciality.equals("")) {
  			   ...
  			   if(schedule.equals("")) {
  				   ...
  				   try {
  			    	...
  			    	JDBCDoctorController.getDoctorController().insertDoctorWithoutId(doctor);
    ...
    public void viewDetailsClicked(ActionEvent event) {
          ...
          if(doctor!=null) {
        	  ...
        	  doctorDetails.prefHeightProperty().bind(mainPane.prefHeightProperty());
        	  doctorDetails.prefWidthProperty().bind(mainPane.prefWidthProperty());
